...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: `If an account with ${email} exists, you will receive an email with instructions.`,
    });
    navigate("/");
  };
  ...
  return (
    <div className="min-h-screen flex">
      {/* reuse left panel design from login/register */}
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">
            Enter the email associated with your account and we'll send you instructions to reset
            your password.
          </p>
